import cv2
import json
train_image_path = 'D:/elephant/tianchi_streetview/mchar_train/'
val_image_path = 'D:/elephant/tianchi_streetview/mchar_val/'
train_annotation_path = 'D:/elephant/tianchi_streetview/mchar_train.json'
val_annotation_path = 'D:/elephant/tianchi_streetview/mchar_val.json'
train_data = json.load(open(train_annotation_path))
val_data = json.load(open(val_annotation_path))
label_path = 'D:/elephant/tianchi_streetview/coco/labels/'
train_label_path = label_path + 'train/'
val_label_path = label_path + 'val/'

for key in train_data:
    f = open(train_label_path+key.replace('.png', '.txt'), 'w')
